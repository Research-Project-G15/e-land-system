...
import { AlertTriangle, User, Key, Users, ArrowRight, Scale, MapPin, UserCheck } from 'lucide-react';
...
const ExternalRegister = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.fullName || !formData.username || !formData.password || 
        !formData.profession || !formData.gender || !formData.province || !formData.district) {
